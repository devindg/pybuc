...
air = pd.read_csv('/home/devin/PycharmProjects/pybuc/examples/data/airline-passengers.csv', header=0, index_col=0)
...
if __name__ == '__main__':
    ...
    plt.title('SARIMA Airline: Forecast')
    ...
    buc.set_seed(123)
    bayes_uc = buc.BayesianStructuralTimeSeries(outcome=y_train,
                                                level=True, stochastic_level=True,
                                                slope=True, stochastic_slope=True,
                                                seasonal=0, stochastic_seasonal=True,
                                                trig_seasonal=((12, 6),), stochastic_trig_seasonal=(True,))
